...
The `release_in_the_mix` dataset is labeled using `meta.csv`:
...
dataset/mix/  Labeled release dataset
```
...
The default command combines all three datasets. The release dataset is labeled from `dataset/mix/meta.csv`:
